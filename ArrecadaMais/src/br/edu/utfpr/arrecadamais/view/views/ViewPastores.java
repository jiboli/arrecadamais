 ...
 * @author JoãoHenrique
 */
public class ViewPastores extends javax.swing.JFrame {

    /**
     * Creates new form ViewPastores
     */
    public ViewPastores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Sobrenome", "Telefone", "Salário"
            }
        ) {
        ...
        btInserir.setText("Cadastrar novo Pastor");
        ...
        btExcluir.setText("Excluir Pastor Selecionado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPastores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPastores().setVisible(true);
            }
        });
    }
